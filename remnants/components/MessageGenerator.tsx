...
export default function MessageGenerator({ voiceId, userName }: MessageGeneratorProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Generate Voice Messages</h2>
      ...
      {audioUrl && (
        <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
          <h3 className="font-semibold text-green-800 mb-2">✓ Message Generated!</h3>
          <p className="text-sm text-gray-700 mb-3 italic">&quot;{generatedMessage}&quot;</p>
